...
1- main.in: This is the primary script to interface with the simulation.
            - Setting Simulation Variables: Brush Topology, Compresive Pressure
...
3- ecs.in: This is a LAMMPS script that performs the simulation (Equilibration, Compression and Shearing).
           - It starts be reading the MDPBB.rst file
           ...
           - Output:
                    ...
                    - full_**.dump: Dump files containing all the beads (**=eq,cp,sh)
                    - beads_**.dump: Dump files that contain only the beads (**=eq,cp,sh)
